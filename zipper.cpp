...
void Zipper::zip(PolyLine * b1, PolyLine * b2,  Mesh &mesh, float trianglePenalty)
{
    if(!(b1 -> isLoop) && !(b2 -> isLoop))
    {
        vector<Vertex*> boarder1 = b1 -> vertices;
        ...
        if(optionA <= optionB) //Start match start, end match end
        {
            ...
            do
            {
                if(counter % 2 == 0) // We need to do this symetrically
                {
                    ...
                    if(bestOption == optionA1)
                    {
                        mesh.addQuadFace(b1left, b2left, b2leftnext, b1leftnext);
                        bIt1start += 1;
                        bIt2start += 1;
                        b1left = (*bIt1start);
                        b2left = (*bIt2start);
                    ...
                    {
                        mesh.addTriFace(b1left, b2left, b2leftnext);
                        bIt2start += 1;
                        b2left = (*bIt2start);
                    }
                    else
                    {
                        mesh.addTriFace(b1left, b2left, b1leftnext);
                        bIt1start += 1;
                        b1left = (*bIt1start);
                    }
                }
                else
                {
                    ...
                    if(bestOption == optionA1)
                    {
                        mesh.addQuadFace(b1rightnext, b2rightnext, b2right, b1right);
                        bIt1end -= 1;
                        bIt2end -= 1;
                        b1right = (*bIt1end);
                        b2right = (*bIt2end);
                    ...
                    {
                        mesh.addTriFace(b2rightnext, b2right, b1right);
                        bIt2end -= 1;
                        b2right = (*bIt2end);
                    }
                    else
                    {
                        mesh.addTriFace(b1rightnext, b2right, b1right);
                        bIt1end -= 1;
                        b1right = (*bIt1end);
                    }
                }
